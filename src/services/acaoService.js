...
const addItinerario = {
  ...
  parameters: {
    ...
    properties: {
      viagem_id: {
        type: Type.INTEGER,
        description: "ID da viagem a que se quer adicionar o dia",
      },
      dia: { type: Type.INTEGER, description: "Número do dia da viagem" },
      local_nome: {
        type: Type.STRING,
        description: "Local ou cidade a visitar",
      },
...
const getItinerario = {
  ...
  parameters: {
    ...
    properties: {
      viagem_id: {
        type: Type.INTEGER,
        description: "ID da viagem para buscar o intinerário correspondente",
      },
    },
    required: ["viagem_id"],
  },
...
// Configuração do chat para usar as funções definidas
